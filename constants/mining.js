module.exports = {
  ...
  perks: {
    gemstone_infusion: { name: 'Gemstone Infusion', id: 'gemstone_infusion', max: 3, type: 'perk' },
    gifts_from_the_departed: { name: 'Gifts From The Departed', id: 'gifts_from_the_departed', max: 100, type: 'ability' },
    frozen_solid: { name: 'Frozen Solid', id: 'frozen_solid', max: 1, type: 'perk' },
    dead_mans_chest: { name: "Dead Man's Chest", id: 'hungry_for_more', max: 50, type: 'perk' },
    excavator: { name: 'Excavator', id: 'excavator', max: 50, type: 'perk' },
    rags_to_riches: { name: 'Rags to Riches', id: 'rags_of_riches', max: 50, type: 'perk' },
    hazardous_miner: { name: 'Hazardous Miner', id: 'hazardous_miner', max: 3, type: 'ability' },
    surveyor: { name: 'Surveyor', id: 'surveyor', max: 20, type: 'perk' },
    subzero_mining: { name: 'SubZero Mining', id: 'subzero_mining', max: 100, type: 'perk' },
    eager_adventurer: { name: 'Eager Adventurer', id: 'eager_adventurer', max: 100, type: 'perk' },
    keen_eye: { name: 'Keen Eye', id: 'keen_eye', max: 1, type: 'perk' },
    warm_hearted: { name: 'Warm Hearted', id: 'warm_hearted', max: 50, type: 'perk' },
    dust_collector: { name: 'Dust Collector', id: 'dust_collector', max: 20, type: 'perk' },
    daily_grind: { name: 'Daily Grind', id: 'daily_grind', max: 100, type: 'perk' },
    strong_arm: { name: 'Strong Arm', id: 'strong_arm', max: 100, type: 'perk' },
    no_stone_unturned: { name: 'No Stone Unturned', id: 'no_stone_unturned', max: 50, type: 'perk' },
    mineshaft_mayhem: { name: 'Mineshaft Mayhem', id: 'mineshaft_mayhem', max: 1, type: 'perk' },
