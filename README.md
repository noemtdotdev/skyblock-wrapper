...
A simplified hypixel skyblock API wrapper focused on profile data.
...
- Multiple profile support for users
- Skills, networth, dungeons, and more
...
The Port normally defaults to `3002`. If you want to change that, you can do so by changing the `PORT` environment variable.
...
| armor          | Get a player's armor                                                    | profile/profiles          |
| equipment      | Get a player's equipment                                                | profile/profiles          |
